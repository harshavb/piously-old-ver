...
namespace Piously.Game.Screens.Menu
{
    public class ButtonSystem : Container, IStateful<ButtonSystemState>, IKeyBindingHandler<GlobalAction>
    {
        ...
        private PiouslyLogo logo;

        /// <summary>
        /// Assign the <see cref="PiouslyLogo"/> that this ButtonSystem should manage the position of.
        /// </summary>
        ...
        public void SetPiouslyLogo(PiouslyLogo logo)
        {
            this.logo = logo;

            if (this.logo != null)
            {
                this.logo.Action = onPiouslyLogo;
        ...
        public ButtonSystem()
        {
            ...
            buttonArea.AddRange(new Drawable[]
            {
                ...
                backButton = new Button(@"back", @"button-back-select", FontAwesome.Solid.Circle, new Color4(51, 58, 94, 255), () => State = ButtonSystemState.TopLevel, -WEDGE_WIDTH)
                {
