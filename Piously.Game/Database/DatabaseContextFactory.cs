...
namespace Piously.Game.Database
{
    public class DatabaseContextFactory : IDatabaseContextFactory
    {
        ...
        private ThreadLocal<PiouslyDbContext> threadContexts;
        ...
        private void recycleThreadContexts()
        {
            ...
            threadContexts = new ThreadLocal<PiouslyDbContext>(CreateContext, true);
        }

        protected virtual PiouslyDbContext CreateContext() => new PiouslyDbContext(storage.GetDatabaseConnectionString(database_name))
        {
