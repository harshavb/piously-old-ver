...
{
    class DrawablePiouslyMenuItem : Menu.DrawableMenuItem
    {
        ...
        public DrawablePiouslyMenuItem(MenuItem item)
            : base(item)
        {
        }
        ...
        {
            switch ((Item as PiouslyMenuItem)?.Type)
            {
                default:
        ...
        protected class TextContainer : Container, IHasText
        {
            ...
            public TextContainer()
            {
                ...
                {
                    NormalText = new PiouslySpriteText
                    {
                        Anchor = Anchor.CentreLeft,
                        Origin = Anchor.CentreLeft,
                        Font = PiouslyFont.GetFont(size: text_size),
                        Margin = new MarginPadding { Horizontal = MARGIN_HORIZONTAL, Vertical = MARGIN_VERTICAL },
                    },
                    BoldText = new PiouslySpriteText
                    {
                        AlwaysPresent = true,
                        Alpha = 0,
                        Anchor = Anchor.CentreLeft,
