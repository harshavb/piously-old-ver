...
{
    public class DialogButton : PiouslyClickableContainer
    {
        ...
        public DialogButton()
        {
            ...
            Children = new Drawable[]
            {
                                ...
                                new Container
                                {
                                    ...
                                    Children = new[]
                                    {
                                        new Hexagons
                                        {
                                            RelativeSizeAxes = Axes.Both,
                                            HexagonScale = 4,
                                            ColorDark = PiouslyColor.Gray(0.88f),
                                            Shear = new Vector2(-0.2f, 0),
                                        },
                                    },
                                },
                ...
                spriteText = new PiouslySpriteText
                {
                    Text = Text,
                    Anchor = Anchor.Centre,
                    Origin = Anchor.Centre,
                    Font = PiouslyFont.GetFont(size: 28, weight: FontWeight.Bold),
                    Shadow = true,
        ...
        private Color4 backgroundColour = PiouslyColor.Gray(34);
