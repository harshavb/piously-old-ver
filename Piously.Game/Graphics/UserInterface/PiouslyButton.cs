...
namespace Piously.Game.Graphics.UserInterface
{
    ...
    /// </summary>
    public class PiouslyButton : Button
    {
        public string Text
        {
            get => SpriteText?.Text;
        ...
        public PiouslyButton(HoverSampleSet? hoverSounds = HoverSampleSet.Loud)
        {
            Height = 40;
        ...
        protected virtual SpriteText CreateText() => new PiouslySpriteText
        {
            Depth = -1,
            Origin = Anchor.Centre,
            Anchor = Anchor.Centre,
