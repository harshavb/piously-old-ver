...
namespace Piously.Game.Graphics.UserInterface
{
    ...
    /// </summary>
    public class PiouslyAnimatedButton : PiouslyClickableContainer
    {
        /// <summary>
        /// The colour that should be flashed when the <see cref="PiouslyAnimatedButton"/> is clicked.
        /// </summary>
        ...
        /// <summary>
        /// The background colour of the <see cref="PiouslyAnimatedButton"/> while it is hovered.
        /// </summary>
