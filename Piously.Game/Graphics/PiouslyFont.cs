...
{
    public static class PiouslyFont
    {
        /// <summary>
    ...
    public static class OsuFontExtensions
    {
        ...
        {
            string familyString = typeface != null ? PiouslyFont.GetFamilyString(typeface.Value) : usage.Family;
            string weightString = weight != null ? PiouslyFont.GetWeightString(familyString, weight.Value) : usage.Weight;
