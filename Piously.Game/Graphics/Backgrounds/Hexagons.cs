...
namespace Piously.Game.Graphics.Backgrounds
{
    public class Hexagons : Drawable
    {
        ...
        private Color4 colorLight = Color4.White;

        public Color4 ColorLight
        {
            get => colorLight;
            set
            {
                if (colorLight == value) return;
        ...
        private Color4 colorDark = Color4.Black;

        public Color4 ColorDark
        {
            get => colorDark;
            set
            {
                if (colorDark == value) return;
        ...
        {
            HexagonParticle particle = CreateTriangle();
        ...
        protected virtual HexagonParticle CreateTriangle()
        {
        ...
        protected virtual Color4 CreateHexagonShade(float shade) => Interpolation.ValueAt(shade, colorDark, colorLight, 0, 1);
        ...
        private class HexagonsDrawNode : PiouslyDrawNode
        {
            protected new Hexagons Source => (Hexagons)base.Source;

            private IShader shader;
            private PiouslyTexture texture;
