...
{
    public class PiouslyScrollContainer : ScrollContainer<Drawable>
    {
        ...
        public PiouslyScrollContainer(Direction scrollDirection = Direction.Vertical)
        ...
        protected override ScrollbarContainer CreateScrollbar(Direction direction) => new PiouslyScrollbar(direction);

        protected class PiouslyScrollbar : ScrollbarContainer
        {
            ...
            public PiouslyScrollbar(Direction scrollDir)
                : base(scrollDir)
            {
