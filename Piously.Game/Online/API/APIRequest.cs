...
namespace Piously.Game.Online.API
{
    ...
    {
        protected override WebRequest CreateWebRequest() => new PiouslyJsonWebRequest<T>(Uri);
        ...
        {
            base.PostProcess();
            Result = ((PiouslyJsonWebRequest<T>)WebRequest)?.ResponseObject;
        }
    ...
    public abstract class APIRequest
    {
        ...
        protected virtual WebRequest CreateWebRequest() => new PiouslyWebRequest(Uri);
