...
using Piously.Game.Overlays.Chat.Selection;
using Piously.Game.Overlays.Chat.Tabs;
using osuTK.Input;
...
{
    public class ChatOverlay : PiouslyFocusedOverlayContainer, INamedOverlayComponent
    {
        ...
        private void load(PiouslyConfigManager config, PiouslyColor colors, TextureStore textures)
        {
            ...
            ChatHeight = config.GetBindable<float>(PiouslySetting.ChatDisplayHeight);
            ...
            chatBackground.Colour = colors.ChatBlue;
