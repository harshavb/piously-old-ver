...
namespace Piously.Game.Overlays
{
    public abstract class OverlayStreamItem<T> : TabItem<T>
    {
            ...
            AddRange(new Drawable[]
            {
                text = new FillFlowContainer<SpriteText>
                {
                    ...
                    Children = new[]
                    {
                        ...
                        {
                            Text = AdditionalText,
                            Font = PiouslyFont.GetFont(size: 16, weight: FontWeight.Regular),
                        },
                        new PiouslySpriteText
                        {
                            Text = InfoText,
                            Font = PiouslyFont.GetFont(size: 10),
        ...
        protected abstract Color4 GetBarColour(PiouslyColor colors);
