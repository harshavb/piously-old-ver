...
namespace Piously.Game.Overlays.Chat.Selection
{
    public class ChannelSelectionOverlay : WaveOverlayContainer
    {
        ...
        {
            bg.Colour = colors.Gray3;
            hexagons.ColorDark = colors.Gray3;
            hexagons.ColorLight = Color4Extensions.FromHex(@"353535");

            headerBg.Colour = colors.Gray2.Opacity(0.75f);
        }
