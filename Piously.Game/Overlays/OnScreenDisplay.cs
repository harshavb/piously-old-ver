...
using Piously.Game.Overlays.OSD;
...
namespace Piously.Game.Overlays
{
    ...
    public class OnScreenDisplay : Container
    {
        ...
        private void load(FrameworkConfigManager frameworkConfig, PiouslyConfigManager piouslyConfig)
        {
            BeginTracking(this, frameworkConfig);
            BeginTracking(this, piouslyConfig);
        }
