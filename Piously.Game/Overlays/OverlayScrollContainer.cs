...
{
    /// <summary>
    /// <see cref="PiouslyScrollContainer"/> which provides <see cref="ScrollToTopButton"/>. Mostly used in <see cref="FullscreenOverlay{T}"/>.
    /// </summary>
    public class OverlayScrollContainer : PiouslyScrollContainer
    {
        /// <summary>
        ...
        public class ScrollToTopButton : PiouslyHoverContainer
        {
            ...
            private void load(OverlayColorProvider colorProvider)
            {
                ...
                flashColour = colorProvider.Light1;
            }
