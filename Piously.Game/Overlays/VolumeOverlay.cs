...
namespace Piously.Game.Overlays
{
    public class VolumeOverlay : VisibilityContainer
    {
        ...
        private void load(AudioManager audio, PiouslyColor colors)
        {
            AutoSizeAxes = Axes.X;
            ...
            AddRange(new Drawable[]
            {
                ...
                new FillFlowContainer
                {
                    ...
                    {
                        volumeMeterEffect = new VolumeMeter("EFFECTS", 125, colors.BlueDarker),
                        volumeMeterMaster = new VolumeMeter("MASTER", 150, colors.PinkDarker),
                        volumeMeterMusic = new VolumeMeter("MUSIC", 125, colors.BlueDarker),
                    }
                }
            });
