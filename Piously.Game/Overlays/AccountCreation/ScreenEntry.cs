...
namespace Piously.Game.Overlays.AccountCreation
{
    public class ScreenEntry : AccountCreationScreen
    {
        ...
        private PiouslyTextBox usernameTextBox;
        private PiouslyTextBox emailTextBox;
        private PiouslyPasswordTextBox passwordTextBox;
        ...
        private PiouslyTextBox[] textboxes;
                ...
                mainContent = new FillFlowContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        new PiouslySpriteText
                        {
                            ...
                            Anchor = Anchor.TopCentre,
                            Origin = Anchor.TopCentre,
                            Font = PiouslyFont.GetFont(size: 20),
                            Text = "Let's create an account!",
                        },
                        usernameTextBox = new PiouslyTextBox
                        {
                        ...
                        emailTextBox = new PiouslyTextBox
                        {
                        ...
                        passwordTextBox = new PiouslyPasswordTextBox
                        {
        ...
        private PiouslyTextBox nextUnfilledTextbox() => textboxes.FirstOrDefault(t => string.IsNullOrEmpty(t.Text));
    }
}
