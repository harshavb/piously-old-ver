...
{
    public class VotePill : LoadingButton, IHasAccentColor
    {
        ...
        private PiouslySpriteText votesCounter;
        ...
        {
            AccentColor = borderContainer.BorderColour = sideNumber.Colour = colors.GreenLight;
        ...
        protected override void LoadComplete()
        {
            ...
            isVoted.BindValueChanged(voted => background.Colour = voted.NewValue ? AccentColor : colorProvider.Background6, true);
        ...
        protected override Drawable CreateContent() => new Container
        {
            ...
            Children = new Drawable[]
            {
                ...
                sideNumber = new PiouslySpriteText
                {
                ...
                votesCounter = new PiouslySpriteText
                {
