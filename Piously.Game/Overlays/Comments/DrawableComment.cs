...
using Piously.Game.Overlays.Comments.Buttons;
...
namespace Piously.Game.Overlays.Comments
{
    public class DrawableComment : CompositeDrawable
    {
        ...
        private void load(OverlayColorProvider colorProvider)
        {
                                        ...
                                        new FillFlowContainer
                                        {
                                            ...
                                            Children = new Drawable[]
                                            {
                                                new FillFlowContainer
                                                {
                                                    ...
                                                    Children = new Drawable[]
                                                    {
                                                        username = new LinkFlowContainer(s => s.Font = PiouslyFont.GetFont(size: 14, weight: FontWeight.Bold))
                                                        {
                                                            AutoSizeAxes = Axes.Both
                                                        },
                                                ...
                                                message = new LinkFlowContainer(s => s.Font = PiouslyFont.GetFont(size: 14))
                                                {
                                                    RelativeSizeAxes = Axes.X,
                                                    AutoSizeAxes = Axes.Y
                                                },
            ...
            {
                info.Add(new PiouslySpriteText
                {
            ...
            {
                content.FadeColour(PiouslyColor.Gray(0.5f));
                votePill.Hide();
            }
