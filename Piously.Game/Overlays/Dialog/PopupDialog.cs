                    ...
                    Children = new Drawable[]
                    {
                        new Container
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                {
                                    RelativeSizeAxes = Axes.Both,
                                    ColorLight = Color4Extensions.FromHex(@"271e26"),
                                    ColorDark = Color4Extensions.FromHex(@"1e171e"),
                                    HexagonScale = 4,
                                },
                            },
                        },
                        new FillFlowContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                header = new PiouslyTextFlowContainer(t => t.Font = t.Font.With(size: 25))
                                {
                                    Origin = Anchor.TopCentre,
                                    Anchor = Anchor.TopCentre,
                                    RelativeSizeAxes = Axes.X,
                                ...
                                body = new PiouslyTextFlowContainer(t => t.Font = t.Font.With(size: 18))
                                {
                                    Origin = Anchor.TopCentre,
                                    Anchor = Anchor.TopCentre,
                                    TextAnchor = Anchor.TopCentre,
