...
using Piously.Game.Overlays.Profile.Header;
...
namespace Piously.Game.Overlays.Profile
{
    public class ProfileHeader : TabControlOverlayHeader<string>
    {
        ...
        private CenterHeaderContainer centerHeaderContainer;
        ...
        public ProfileHeader()
        {
            ...
            centerHeaderContainer.DetailsVisible.BindValueChanged(visible => detailHeaderContainer.Expanded = visible.NewValue, true);
        }
