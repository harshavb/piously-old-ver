...
namespace Piously.Game.Overlays
{
    ...
    {
        protected PiouslyTabControl<T> TabControl;
        ...
        {
            controlBackground.Colour = colorProvider.Dark4;
        }

        [NotNull]
        protected virtual PiouslyTabControl<T> CreateTabControl() => new OverlayHeaderTabControl();
        ...
        public class OverlayHeaderTabControl : OverlayTabControl<T>
        {
            ...
            private class OverlayHeaderTabItem : OverlayTabItem
            {
                    ...
                    : base(value)
                {
                    ...
                    Text.Font = PiouslyFont.GetFont(size: 14);
