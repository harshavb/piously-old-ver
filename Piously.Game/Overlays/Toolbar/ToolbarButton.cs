...
{
    public abstract class ToolbarButton : PiouslyClickableContainer, IKeyBindingHandler<GlobalAction>
    {
            ...
            : base(HoverSampleSet.Loud)
        {
            ...
            Children = new Drawable[]
            {
                HoverBackground = new Box
                {
                    ...
                    Colour = PiouslyColor.Gray(80).Opacity(180),
                ...
                Flow = new FillFlowContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        DrawableText = new PiouslySpriteText
                        {
                            Anchor = Anchor.CentreLeft,
                            Origin = Anchor.CentreLeft,
                        },
                ...
                tooltipContainer = new FillFlowContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        tooltip1 = new PiouslySpriteText
                        {
                            Anchor = TooltipAnchor,
                            Origin = TooltipAnchor,
                            Shadow = true,
                            Font = PiouslyFont.GetFont(size: 22, weight: FontWeight.Bold),
                        },
                        new FillFlowContainer
                        {
                            ...
                            Children = new[]
                            {
                                tooltip2 = new PiouslySpriteText { Shadow = true },
                                keyBindingTooltip = new PiouslySpriteText { Shadow = true }
                            }
                        }
                    }
                }
    ...
    public class OpaqueBackground : Container
    {
        public OpaqueBackground()
        {
            ...
            Children = new Drawable[]
            {
                ...
                {
                    RelativeSizeAxes = Axes.Both,
                    Colour = PiouslyColor.Gray(30)
                },
                new Hexagons
                {
                    RelativeSizeAxes = Axes.Both,
                    ColorLight = PiouslyColor.Gray(40),
                    ColorDark = PiouslyColor.Gray(20),
                },
            };
        }
    }
